    ...
    public partial class AddWalletAndMLMPermissions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    INSERT INTO Actions (Id, Code, Name, Description, CreatedOn, CreatedBy, IsActive)
                    VALUES (NEWID(), 'MarkPaid', 'Mark Paid', 'Mark commission as paid', GETDATE(), 'System', 1)
                END
                ...
                BEGIN
                    ...
                    INSERT INTO Pages (Id, Code, Name, ModuleName, Description, CreatedOn, CreatedBy, IsActive)
                    VALUES (@WalletPageId, 'WALLET', 'Wallet', 'WalletModule', 'Wallet management', GETDATE(), 'System', 1)
                END
                ELSE
                BEGIN
                ...
                BEGIN
                    ...
                    INSERT INTO Pages (Id, Code, Name, ModuleName, Description, CreatedOn, CreatedBy, IsActive)
                    VALUES (@CommissionsPageId, 'Commissions', 'Commissions', 'MLMModule', 'Commission management', GETDATE(), 'System', 1)
                END
                ELSE
                BEGIN
                ...
                BEGIN
                    ...
                    INSERT INTO Pages (Id, Code, Name, ModuleName, Description, CreatedOn, CreatedBy, IsActive)
                    VALUES (@CommissionRulesPageId, 'CommissionRules', 'Commission Rules', 'MLMModule', 'Commission rules management', GETDATE(), 'System', 1)
                END
                ELSE
                BEGIN
                ...
                BEGIN
                    ...
                    INSERT INTO Pages (Id, Code, Name, ModuleName, Description, CreatedOn, CreatedBy, IsActive)
                    VALUES (@UserReferralsPageId, 'UserReferrals', 'User Referrals', 'MLMModule', 'User referrals management', GETDATE(), 'System', 1)
                END
                ELSE
                BEGIN
                ...
                BEGIN
                    INSERT INTO Permissions (Id, PageId, ActionId, Name, Description, CreatedOn, CreatedBy, IsActive)
                    VALUES (NEWID(), @WalletPageId, @ReadActionId, 'WALLET:Read', 'WALLET Read permission', GETDATE(), 'System', 1)
                END
                ...
                BEGIN
                    INSERT INTO Permissions (Id, PageId, ActionId, Name, Description, CreatedOn, CreatedBy, IsActive)
                    VALUES (NEWID(), @WalletPageId, @ManageActionId, 'WALLET:Manage', 'WALLET Manage permission', GETDATE(), 'System', 1)
                END
                ...
                BEGIN
                    INSERT INTO Permissions (Id, PageId, ActionId, Name, Description, CreatedOn, CreatedBy, IsActive)
                    VALUES (NEWID(), @CommissionsPageId, @ReadActionId, 'Commissions:Read', 'Commissions Read permission', GETDATE(), 'System', 1)
                END
                ...
                BEGIN
                    INSERT INTO Permissions (Id, PageId, ActionId, Name, Description, CreatedOn, CreatedBy, IsActive)
                    VALUES (NEWID(), @CommissionsPageId, @MarkPaidActionId, 'Commissions:MarkPaid', 'Commissions MarkPaid permission', GETDATE(), 'System', 1)
                END
                ...
                BEGIN
                    INSERT INTO Permissions (Id, PageId, ActionId, Name, Description, CreatedOn, CreatedBy, IsActive)
                    VALUES (NEWID(), @CommissionRulesPageId, @CreateActionId, 'CommissionRules:Create', 'CommissionRules Create permission', GETDATE(), 'System', 1)
                END
                ...
                BEGIN
                    INSERT INTO Permissions (Id, PageId, ActionId, Name, Description, CreatedOn, CreatedBy, IsActive)
                    VALUES (NEWID(), @UserReferralsPageId, @CreateActionId, 'UserReferrals:Create', 'UserReferrals Create permission', GETDATE(), 'System', 1)
                END
